...
// Write a fragment's metadata to memory, and data to S3
async function writeFragment(fragment) {
  try {
    ...
    logger.debug({ fragmentId: fragment.id }, 'Fragment written to S3');
  } catch (err) {
    logger.error({ err, fragmentId: fragment.id }, 'Error writing fragment to S3');
    throw err;
  }
}
